...
def render_item_description(consoles, player):
    ...
    console.print(1, 1, _item_name, fg=COLORS['hud_skill_description'])
    console.print(1, 2, _skill_name, fg=COLORS['hud_skill_description'])

    y = 0
    for line in _skill_description_lines:
        console.print(1, 4 + y, line, fg=COLORS['hud_skill_description'])
        y += 1
