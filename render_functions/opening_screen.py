...
def render_opening_screen(consoles):
    ...
    console.print(3, 6, 'Use the numpad to move. Use Spacebar to equip items from the ground, or to inspect souls before consuming them. Press 5 on the numpad or enter to confirm choice.')
